<template>
    <div v-if="slider === 1" class="bg">
        ...
        <div class="overlayText">
            ...
            (akademski slikar, kipar, grafičar, profesor likovne kulture), dvoje ima završenu visoku školu likovnog
    ...
    <div v-else class="bg">
        ...
        <div class="overlayText">
            <h4>NEKAD</h4>
            Galerijski prostor u nekoj sredini pruža mogućnost uvida u aktualna događanja u likovnoj umjetnosti, a samim
            tim i nastajanje umjetnika. HDLU Varaždin je rijetka strukovna udruga kod nas, koja još uvijek nema svoj
            izložbeni prostor i kao predvodnik suvremenosti ne moće u pravoj mjeri pokazati aktivnost svojih članova,
            niti svjetski trend.
            <div class="showMoreBtn">...više</div>
        </div>
    </div>
    <div class="sliderIcons">
        <div @click="slider = 1">
            <Slider :active="slider === 1" />
        </div>
        <div @click="slider = 2">
            <Slider :active="slider === 2" />
        </div>
    </div>
</template>
